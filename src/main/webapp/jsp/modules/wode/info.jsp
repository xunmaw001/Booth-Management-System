    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑我的摊位</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">我的摊位登记</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">我的摊位信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="taanweiName" name="taanweiName" class="form-control"
                                                   v-model="ruleForm.taanweiName" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="taanweiValue" name="taanweiValue" class="form-control"
                                               v-model="ruleForm.taanweiValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="taanweiId" name="taanweiId" v-model="ruleForm.taanweiId" readonly type="hidden">
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.taanweiContent != null && ruleForm.taanweiContent != 'null' && ruleForm.taanweiContent != '') {
            var taanweiContentUeditor = UE.getEditor('taanweiContentEditor');
                taanweiContentUeditor.ready(function () {
                    ...
                    taanweiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function exit() {
        ...
        window.sessionStorage.removeItem('addwode');
