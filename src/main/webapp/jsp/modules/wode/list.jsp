...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">我的摊位管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">我的摊位管理</li>
                            <li class="breadcrumb-item active">我的摊位列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">我的摊位列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            if(item.taanweiValue == "临时"){
                var detailBtn = document.createElement('button');
                var detailAttr = "shengji(" + item.id + ')';
                detailBtn.setAttribute("type", "button");
                detailBtn.setAttribute("class", "btn btn-primary btn-sm 升级");
                detailBtn.setAttribute("onclick", detailAttr);
                detailBtn.innerHTML = "升级摊位";
                btnGroup.appendChild(detailBtn);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("wode/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        // 删除
        function shengji(id) {
            var mymessage = confirm("真的要申请升级摊位吗？");
            if (mymessage == true) {
                http("wode/shengji?ids="+id, "get", {}, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('操作成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addwode", "addwode");
            window.location.href = "add-or-update.jsp"
        }
