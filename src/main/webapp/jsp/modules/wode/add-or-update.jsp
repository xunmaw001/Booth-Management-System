            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑我的摊位</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#taanweiId") !=null){
            ...
            httpJson("wode/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
    ...
    // 获取当前详情
    function getDetails() {
        var addwode = window.sessionStorage.getItem("addwode");
        if (addwode != null && addwode != "" && addwode != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("wode/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
        if(window.sessionStorage.getItem('addwode') != null && window.sessionStorage.getItem('addwode') !=""){//新增查询,修改不查
            // 查询当前登录账户的信息
            var userId = window.sessionStorage.getItem('userId');
