...
public class ShenqingView extends ShenqingEntity implements Serializable {
	...
	public ShenqingView(ShenqingEntity shenqingEntity) {
		try {
			...
			* 获取： 申请类型的值
			*/
			public String getShenqingValue() {
				return shenqingValue;
			}
			/**
			* 设置： 申请类型的值
			*/
			public void setShenqingValue(String shenqingValue) {
				this.shenqingValue = shenqingValue;
			}
